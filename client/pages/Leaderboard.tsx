...
import { fetchScores, fetchContests, transformScoresData, transformContestData, testConnection, checkTables, inspectTableStructure, supabase, type Score, type Contest } from "@/lib/supabase";
                    ...
                    <div className="mt-8">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {Object.entries(scores.quicksands).map(([teamName, teamScores]) => {
                          const teamScore = teamScores?.reduce((sum: number, score: number | null, index: number) =>
                            sum + calculateStablefordPoints(score, courseData.quicksands.pars[index]), 0) || 0;
