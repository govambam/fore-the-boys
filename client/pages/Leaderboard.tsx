...
import { fetchScores, fetchContests, transformScoresData, transformContestData, testConnection, checkTables, inspectTableStructure, type Score, type Contest } from "@/lib/supabase";
